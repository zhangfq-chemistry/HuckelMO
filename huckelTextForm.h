...
public:
    ...
    void setCalExtendedHuckel() {
        isExtendedHuckelCal=true;
        isXTBCal=false;isHuckelCal=false;
    }
    void setCalHuckel() {
        isHuckelCal=true;
        isXTBCal=false;
        isExtendedHuckelCal=false;
    }
    ...
    void  runXTB();
    void  runEHMO();
    void  factor_lll(Poly & det);
    void  factor_eigenMath(Poly & det);

/********************************************************************************
** Form generated from reading UI file 'angle.ui'
**
...
public:
    ...
    void setupUi(QDialog *Dialog_angle)
    {
        if (Dialog_angle->objectName().isEmpty())
            Dialog_angle->setObjectName(QStringLiteral("Dialog_angle"));
        Dialog_angle->resize(566, 306);
        layoutWidget = new QWidget(Dialog_angle);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(112, 251, 361, 34));
        ...
        layoutWidget1 = new QWidget(Dialog_angle);
        layoutWidget1->setObjectName(QStringLiteral("layoutWidget1"));
        layoutWidget1->setGeometry(QRect(20, 180, 531, 57));
        ...
        layoutWidget2 = new QWidget(Dialog_angle);
        layoutWidget2->setObjectName(QStringLiteral("layoutWidget2"));
        layoutWidget2->setGeometry(QRect(20, 10, 531, 151));
        ...
        retranslateUi(Dialog_angle);

        QMetaObject::connectSlotsByName(Dialog_angle);
    } // setupUi

    void retranslateUi(QDialog *Dialog_angle)
    {
        Dialog_angle->setWindowTitle(QApplication::translate("Dialog_angle", "Dialog", Q_NULLPTR));
        pushButton_cancel->setText(QApplication::translate("Dialog_angle", "Cancel", Q_NULLPTR));
        pushButton_ok->setText(QApplication::translate("Dialog_angle", "OK", Q_NULLPTR));
        label21->setText(QApplication::translate("Dialog_angle", "0.00", Q_NULLPTR));
        label22->setText(QApplication::translate("Dialog_angle", "180.0", Q_NULLPTR));
        label1->setText(QApplication::translate("Dialog_angle", "Atom1", Q_NULLPTR));
        comboBox1->clear();
        comboBox1->insertItems(0, QStringList()
         << QApplication::translate("Dialog_angle", "Fixed", Q_NULLPTR)
         << QApplication::translate("Dialog_angle", "Move atom", Q_NULLPTR)
         << QApplication::translate("Dialog_angle", "Move group", Q_NULLPTR)
        );
        label2->setText(QApplication::translate("Dialog_angle", "Atom3", Q_NULLPTR));
        comboBox2->clear();
...
namespace Ui {
    class Dialog_angle: public Ui_Dialog_angle {};
} // namespace Ui
